                                        ...
                                        <div class="description-item two">
                                            ...
                                            <div class="col-md-3">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="form-label">{{ __('translate.Car Model') }} <span>*</span> </label>
                                                    <input class="form-control" type="text" name="car_model" id="car_model" value="{{ html_decode($car->car_model) }}">
                                                </div>
                                            </div>
