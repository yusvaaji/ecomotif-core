            ...
            <div class="row login-bg">
                <div class="col-lg-6">
                    ...
                    <form method="POST" action="{{ route('user-login') }}">
                        ...
                        @if($google_recaptcha && $google_recaptcha->status==1)
                    ...
                    @if(isset($social_login) && $social_login && ($social_login->is_gmail == 1 || $social_login->is_facebook == 1))
                ...
                <div class="col-lg-6">
                    <div class="login-img">
                        <img src="{{ getImageOrPlaceholder($setting ? $setting->login_page_bg : null, '571x708') }}" alt="img">
                    </div>
                </div>
            </div>
