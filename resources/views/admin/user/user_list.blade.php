                            ...
                            <div class="crancy-table crancy-table--v3 mg-top-30">
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        ...
                                        <div class="crancy-header__form--customer">
                                            <a href="{{ route('admin.user-create') }}" class="crancy-btn crancy-btn__v1">
                                                <i class="fas fa-plus"></i> {{ __('translate.Create User') }}
                                            </a>
                                        </div>
                                    </div>
                                    
                                    <!-- Filter Form -->
                                    <form method="GET" action="{{ route('admin.user-list') }}" class="row g-3 mt-2">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="disable" {{ request('status') == 'disable' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" class="crancy-btn">{{ __('translate.Filter') }}</button>
                                            <a href="{{ route('admin.user-list') }}" class="crancy-btn crancy-btn__v2">{{ __('translate.Reset') }}</a>
                                        </div>
                                    </form>
                                </div>
